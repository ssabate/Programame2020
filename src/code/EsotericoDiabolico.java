    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (diabolic && esoteric) {
                ...
                int cm2 = 4 * cm / n;
                if (esoteric = (cm2 == valors[0] + valors[n - 1] + valors[n * (n - 1)] + valors[n * n - 1])) {
                    if (n % 2 == 0) {
                        ...
                        esoteric = (cm2 == 4 * valors[n * (n / 2) + n / 2]);
                        esoteric= esoteric  && (cm2 == valors[n / 2] + valors[n * (n / 2)] + valors[n * (n / 2 + 1) - 1] + valors[n * (n - 1) + n / 2]);
                    }
